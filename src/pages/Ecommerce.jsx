...
import {
  ...
  weeklyStats,
  dropdownData,
  SparklineAreaDataEcharts,
  stackedChartDataEchats,
  ecomPieChartData,
} from "../data/dummy";
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        ...
        >
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            ...
            {/* --------------------柱状图部分--------------------- */}
            <div>
              <Stacked width={'320px'} height={'360px'} data={stackedChartDataEchats} color={['rgb(74,222,128)','rgb(75,85,99)']}/>
            </div>
          </div>
        </div>
      </div>
